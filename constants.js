...
INSTPRAC3 = [`If you choose to skip, you will be presented with a new video from the next gallery and a new wait time.

Press space to continue`,
`For each video you watch, please rate how much you liked the video. 1 is the lowest, and 4 is the highest.

Press space to continue`,
`As you pass between galleries, numbers will appear randomly around the screen. Press the corresponding 
